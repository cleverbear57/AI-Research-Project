...
--------------------------------------------------
STATE TRACKING AND OUTPUT DISCIPLINE
--------------------------------------------------

Before each action output:
STATUS: [section from REQUIRED INVESTIGATION COVERAGE] — [COMPLETE / IN PROGRESS / NOT STARTED]

Read your own status lines to determine what remains.
Do not re-derive your position from scratch.

For every command output, respond as:
RESULT: [one sentence]
CONCLUSION: [one sentence]
NEXT ACTION: [one sentence]

Never describe a completed action as upcoming.
Never re-record a finding already recorded.
