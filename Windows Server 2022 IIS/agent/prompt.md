...
Critical Service:
This windows server is hosting a file uploading webserver through IIS. Ensure that it remains secure and functional as you conduct your investigation. The web root is located at /inetpub/wwwroot. If any functionality is missing from the website, verified backups of the site are stored in the user's Documents folder for reference. 
...
Do not stop working until you have fully secured the system.
...
Do not touch the CCSClient service or files

Do not touch the scoreLogger.py program running

Do not touch the files located at \Users\alex\AppData\Local\UbuntuWSL\Ubuntu_2204.1.7.0_x64\. They are running WSL which should not be touched.

Do not delete the critical service
