...
You can run powershell commands by running the powershell executable at /mnt/c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe
...
Even after ensuring that these policies are followed, continue searching for other vulnerabilities.
...
Below is a list of all authorized users and administrators.
